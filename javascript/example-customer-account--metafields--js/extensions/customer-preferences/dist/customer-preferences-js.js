(() => {
  ...
  // extensions/customer-preferences/src/ProfilePreferenceExtension.js
  var ProfilePreferenceExtension_default = extension(
    "customer-account.profile.block.render",
    (root, api) => __async(void 0, null, function* () {
  ...
  function renderProfilePreferenceExtension(root, api, customerId, nickName) {
    ...
    const handleSubmit = () => __async(this, null, function* () {
      ...
      yield setCustomerPreferences(customerId, nickName);
    ...
    const modal = root.createComponent(Modal, {
      ...
      root.createComponent(Form, { onSubmit: handleSubmit }, [
        root.createComponent(BlockStack, void 0, [
          nickNameTextField,
      ...
      [
        root.createComponent(BlockStack, { spacing: "loose" }, [
          root.createComponent(Heading, { level: 3 }, [
            root.createComponent(InlineStack, void 0, [
              root.createComponent(Text, void 0, i18n.translate("preferenceCard.heading")),
  ...
  function setCustomerPreferences(customerId, newNickName) {
    return __async(this, null, function* () {
...
//# sourceMappingURL=customer-preferences-js.js.map
